...
- **Research** — `docs/research/competitive-landscape.md` (ContextForge, agentgateway,
...
instance; local ledger only. See `docs/security/security-review.md` (open findings)
and `docs/security/deployment.md`.
